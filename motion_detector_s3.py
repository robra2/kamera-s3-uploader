    ...
    while True:
        ...
        if use_roi_for_this_frame:
            ...
            if (ROI_X < 0 or ROI_Y < 0 or
                ...
                # print(f"DEBUG_ROI: ROI aktiv, Analysiere Bereich: X={ROI_X}, Y={ROI_Y}, W={ROI_WIDTH}, H={ROI_HEIGHT}.")
        # else:
        ...
        # print(f"DEBUG_DIFF: Frame-Differenz berechnet.")
        ...
        # print(f"DEBUG_THRESHOLD: Schwellenwert {THRESHOLD_DELTA} angewendet und dilatiert.")
        ...
        for i, c in enumerate(contours):
            ...
            # print(f"DEBUG_CONTOUR: Kontur {i}, Fläche: {area:.2f} Pixel.")
            if area < MIN_AREA:
